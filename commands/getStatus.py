...
def randomVid():
    ...
    with open('commands/randomVid.json', 'w') as outfile: # output to json file for discord bot
        json.dump(ytLink, outfile)

def main(): # main function
    randomVid() # run the code to get a random video url for the other comands

    jsonFile = 'commands/rustStatus.json' # set what file the json data is in
    ...
    jsonFile = 'commands/minecraftStatus.json' # set what file the json data is in
    data = getUrl(jsonFile) # gets json file
